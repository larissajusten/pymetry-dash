...
class LoadedImages(Singleton):
    ...
    def __init__(self):
        ...
        self.imagens_obtaculos = {'Spike': pygame.image.load(f'{file_paths.imagens}/fake_spike.png').convert_alpha(),
                                  'Win': pygame.image.load(f'{file_paths.imagens}/win.png').convert_alpha(),
                                  'Orb': pygame.image.load(f'{file_paths.imagens}/orb_yellow.png').convert_alpha(),
                                  'Block': pygame.image.load(f'{file_paths.imagens}/block.png').convert_alpha(),
                                  'Portal': pygame.image.load(f'{file_paths.imagens}/portal.png').convert_alpha(),
                                  'PortalSaida': pygame.image.load(f'{file_paths.imagens}/portal_saida.png').convert_alpha()
                                  }
        ...
        self.skin_nave = pygame.image.load(
            f"{file_paths.imagens}/nave_teste.png").convert_alpha()

        self.imagens_skins = {'Padrão': pygame.image.load(f'{file_paths.imagens}/skin_geo.png').convert_alpha(),
                              'Azul': pygame.image.load(f'{file_paths.imagens}/skin_geo_blue.jpg').convert_alpha(),
                              'Glitch': pygame.image.load(f'{file_paths.imagens}/skin_glitch.jpg').convert_alpha(),
                              'Mine': pygame.image.load(f'{file_paths.imagens}/skin_mine_block.png').convert_alpha(),
                              'Cubo Mágico': pygame.image.load(f'{file_paths.imagens}/skin_cubo_magico.jpg').convert_alpha(),
                              'Pride': pygame.image.load(f'{file_paths.imagens}/skin_pride_skin.png').convert_alpha()}
